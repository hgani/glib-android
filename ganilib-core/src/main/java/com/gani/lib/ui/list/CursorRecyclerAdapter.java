...
public abstract class CursorRecyclerAdapter<VH
   ...
   * @return Returns the previously put Cursor, or null if there wasa not one.
   * If the given new Cursor is the same getInstance is the previously put
  ...
  public Cursor swapCursor(Cursor newCursor) {
    ...
    if (newCursor != null) {
      ...
      mRowIDColumn = -1;
      mDataValid = false;
      // notify the observers about the lack of a data put
